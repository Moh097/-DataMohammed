...
# Function to summarize missing data for each country
missing_summary_by_country <- function(merged_data) {
...
by(merged_data, merged_data$country, missing_summary_by_country)
